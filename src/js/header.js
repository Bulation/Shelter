...
export default class Header extends Component {
  ...
  addPetsClass() {
    this.node.classList.add('our-pets-header');
    this.headerContainer.node.classList.add('our-pets-header-container');
    this.title.node.classList.add('our-pets-logo__title');
    this.subtitle.node.classList.add('our-pets-logo__subtitle');
  }

  removePetsClass() {
    this.node.classList.remove('our-pets-header');
    this.headerContainer.node.classList.remove('our-pets-header-container');
    this.title.node.classList.remove('our-pets-logo__title');
    this.subtitle.node.classList.remove('our-pets-logo__subtitle');
  }
}
