...
export default class Slider extends Component {
  constructor(parent, tagName, className, content, itemsCount, names, alt, ourPetsClass) {
    ...
    window.addEventListener('resize', () => {
      if (document.documentElement.clientWidth <= 1279 && window.location.pathname.endsWith('our-pets')
      ...
      if (document.documentElement.clientWidth <= 767 && window.location.pathname.endsWith('our-pets') && this.friendsItems.length === 6) {
        const items = this.friendsItems;
      ...
      if (document.documentElement.clientWidth > 767 && window.location.pathname.endsWith('our-pets') && this.friendsItems.length === 3) {
        this.pushItems(3, 6);
      }
      if (document.documentElement.clientWidth > 1279 && window.location.pathname.endsWith('our-pets') && this.friendsItems.length === 6) {
        this.pushItems(6, 8);
      }
    });
  }
